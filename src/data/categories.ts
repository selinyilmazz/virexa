...
export const categories: Category[] = [
  ...
  },
  {
    ...
    name: "Mobile Games",
    icon: "🕹️",
    description: "Mobile gaming news — hit titles, studios, monetization trends, and the platforms powering play on the go.",
    breadcrumb: [
      { label: "Home", href: "/" },
      { label: "Mobile Games", href: "/category/mobile-games" },
    ],
    popularTags: [
      { label: "Hyper-Casual", count: 34 },
      { label: "Mobile Esports", count: 26 },
      { label: "Gacha", count: 22 },
      { label: "App Store", count: 41 },
      { label: "Google Play", count: 37 },
      { label: "F2P", count: 29 },
      { label: "Mobile Studios", count: 24 },
      { label: "Cross-Platform", count: 19 },
    ],
    news: buildCategoryNews("Mobile Games", "mobile-games", [
      "Top Mobile Game Studios Report Record Downloads",
      "Hyper-Casual Games Drive Mobile Revenue Growth",
      "Mobile Esports Tournaments Draw Global Audiences",
      "Gacha Monetization Faces New Regulatory Scrutiny",
      "Cross-Platform Play Expands to More Mobile Titles",
      "App Store Rules Reshape Mobile Game Distribution",
      "Free-to-Play Mobile Hits Surpass Console Sales",
      "Mobile Game Engines Push Console-Quality Graphics",
      "Indie Mobile Developers Find Success on New Platforms",
      "Mobile Gaming Subscriptions Gain Wider Adoption",
      "Live-Service Mobile Games Battle for Player Retention",
      "AI-Generated Content Enters Mobile Game Development",
    ]),
  },
  {
    slug: "world",
