...
/**
 * Search bar for `/admin/releases` - same URL-param-driven, debounced
 * convention as `AdminRepositoryFilters`/`AdminArticleFilters` (requirement
 * 10: unified pagination/filtering feel across every listing page).
 */
export function AdminReleaseFilters() {
  ...
  function pushParams(mutate: (params: URLSearchParams) => void) {
    ...
    router.push(queryString ? `/admin/releases?${queryString}` : "/admin/releases", { scroll: false });
  }
    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
      <div className="relative flex-1 sm:min-w-64">
        ...
        <input
          ...
          placeholder="Search product, version, or maintainer..."
      ...
      {hasActiveFilters && (
        <button
          ...
          onClick={() => {
            setSearch("");
            router.push("/admin/releases", { scroll: false });
          }}
